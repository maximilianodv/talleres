                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <?php
                                        echo $datos['comboperiodo'];
                                        ?>
                                    </div>
                                    <div class="col-md-6">
                                            <label>Nivel</label>
                                                
                                            <select class="form-control selectC" id="id" multiple="multiple" data-placeholder="Selecciona Carrera"
                            ...
                            <div class="row">
                                 ...
                                 <div class="form-group">
                                    <div class='col-md-6 dias ocultarboton' id="divTSU">
                                        ...
                                        <select class="form-control select2" multiple="multiple" data-placeholder="Selecciona dia(s)"
                                                style="width: 100%" id="cbdiaTSU">
                                          <option>Lunes</option>
...
<script src="recursos/sistema/js/talleres.js"></script> 
<script>
  $(function () {
    //Initialize Select2 Elements
    $('.select2').select2();
     $('.selectC').select2();
     //$('.timepicker').data("DateTimePicker").OPTION();
